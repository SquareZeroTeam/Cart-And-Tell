...
var require_windows = __commonJS({
  "node_modules/isexe/windows.js"(exports2, module2) {
    ...
    function sync(path2, options2) {
      return checkStat(fs.statSync(path2), path2, options2);
    }
  }
});
...
var require_mode = __commonJS({
  "node_modules/isexe/mode.js"(exports2, module2) {
    ...
    function sync(path2, options2) {
      return checkStat(fs.statSync(path2), options2);
    }
...
var require_get_stream = __commonJS({
  "node_modules/get-stream/index.js"(exports2, module2) {
    ...
    module2.exports.buffer = (stream2, options2) => getStream(stream2, __spreadProps(__spreadValues({}, options2), {encoding: "buffer"}));
    module2.exports.array = (stream2, options2) => getStream(stream2, __spreadProps(__spreadValues({}, options2), {array: true}));
...
var makeTag = (commandPrefix, callback) => (literals, ...substs) => {
  let command = "";
  ...
  import_execa.default.commandSync(commandPrefix + command, {
    stdio: "inherit",
    preferLocal: true
  });
...
// src/utils.ts
function loadContext(r2, options2) {
  for (const p of Object.keys(require.cache)) {
    delete require.cache[p];
  }
  r2.context.sh = makeTag("");
  r2.context.prisma = makeTag("prisma ", (command) => {
    if (command === "db push" || command === "generate") {
      loadContext(r2, options2);
    }
  });
  r2.context.db = createPrismaClient({
...
function createPrismaClient({
  ...
  const {
    PrismaClient
  } = require(import_path.default.resolve(client || "node_modules/@prisma/client"));
  return new PrismaClient({
    log: verbose ? ["query", "info", "warn", "error"] : void 0,
    datasources: url ? {
      db: {
        url
      }
...
var r = import_repl.default.start("> ");
r.on("exit", () => process.exit());
r.setupHistory("node_modules/.prisma-repl-history", (err) => {
  if (err)
    console.error(err);
});
var initContext = () => loadContext(r, {verbose: options.verbose, client: options.client});
