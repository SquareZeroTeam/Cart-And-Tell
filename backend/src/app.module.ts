...
@Module({
  imports: [ConfigModule.forRoot(),
    ...
    }),UserModule, AuthModule, PaymongoModule, MerchantModule, ProductsModule, PrismaModule, SupabaseModule, CategoryModule, MessagesModule, LivestreamsModule, VerifyEmailModule],
