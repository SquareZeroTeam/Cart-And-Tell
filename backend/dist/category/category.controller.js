...
__decorate([
    ...
    __param(1, (0, common_1.UploadedFile)(new common_1.ParseFilePipe({ fileIsRequired: false, validators: [new common_1.MaxFileSizeValidator({ maxSize: 1024 * 1024 * 5 }), new common_1.FileTypeValidator({ fileType: "image/*" })] }))),
...
__decorate([
    ...
    __param(2, (0, common_1.UploadedFile)(new common_1.ParseFilePipe({ fileIsRequired: false, validators: [new common_1.MaxFileSizeValidator({ maxSize: 1024 * 1024 * 5 }), new common_1.FileTypeValidator({ fileType: "image/*" })] }))),
    __metadata("design:type", Function),
