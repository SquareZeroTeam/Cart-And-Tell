...
exports.MessagesModule = MessagesModule = __decorate([
    (0, common_1.Module)({
        providers: [messages_gateway_1.MessagesGateway, messages_service_1.MessagesService, jwt_service_1.JwtService],
        imports: [prisma_module_1.PrismaModule, livestreams_module_1.LivestreamsModule]
    })
], MessagesModule);
